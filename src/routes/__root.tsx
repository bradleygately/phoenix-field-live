...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PSI Games Live Crew Control" },
      {
        name: "description",
        content:
          "Field production-operations console for the Mojo Phoenix crew covering PSI Games 2026.",
      },
      { name: "author", content: "Mojo Phoenix Productions" },
      { name: "theme-color", content: "#0E1013" },
      { property: "og:title", content: "PSI Games Live Crew Control" },
      {
